...
def test_riscv64_jalr(qemu_assembly_run):
    ...
    expected = (
        ...
        "   0x100115c <_start+4>     auipc  t0, 0            T0 => 0x100115c"
        " (_start+4)\n"
        ...
        "   0x100116a <_start+18>    auipc  t1, 0            T1 => 0x100116a"
        " (_start+18)\n"
...
def test_riscv64_compressed_loads(qemu_assembly_run):
    ...
    expected = (
        ...
        "───────────────────────[ DISASM / rv64 / set emulate on"
        " ]───────────────────────\n"
        " ► 0x10011b8 <store>       c.sd   a0, 0(a2)          [data] <="
        " 0x1234567890abcdef\n"
        "   0x10011ba <store+2>     c.ld   a1, 0(a2)          A1, [data] =>"
        " 0x1234567890abcdef\n"
        ...
        "   0x10011d2 <store+26>    sll    a3, a1, a2         A3 => 0x40000000000 (0x10"
        " << 0x26)\n"
        "   0x10011d6 <store+30>    mul    a2, a1, a2         A2 => 0x260 (0x10 *"
        " 0x26)\n"
